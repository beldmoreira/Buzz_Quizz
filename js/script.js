    ...
    if(idDiserial!==null){
        if(idDiserial.length>0){
            ...
            for(let i=0; i<idDiserial.length;i++){
                const promise = axios.get(`API/${idDiserial[i]}`);
                    ...
                    <div class="myQuizzesArea">
                        ...
                        <div class="settings-quizz">
                            <svg width="25" height="24" viewBox="0 0 19 18" fill="none" xmlns="http://www.w3.org/2000/svg" onclick="deleteQuizzes(${idDiserial[i]}) >
                            ...
                            <svg width="25" height="28" viewBox="0 0 19 22" fill="none" xmlns="http://www.w3.org/2000/svg" onclick="deleteQuizzes()" >
